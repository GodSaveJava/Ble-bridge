...
本文档定义 ToyLink AI 首发版本面向 Claude 原对话的 Remote MCP 架构。
...
2. `docs/21-remote-bridge-session-and-security-model.md`
   作用：把 session、token、在线状态、掉线恢复和最小数据面写清楚。
