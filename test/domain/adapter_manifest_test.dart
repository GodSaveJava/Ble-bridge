...
void main() {
  group('AdapterManifest', () {
    test('parses valid manifest', () {
      ...
      expect(manifest.source, AdapterSource.official);
      expect(manifest.bleNamePrefixes, contains('SOSEXY'));
    });

    test('defaults missing source to community', () {
      final AdapterManifest manifest = AdapterManifest.fromJson(
        <String, Object?>{
          'schemaVersion': 1,
          'adapterId': 'shared.adapter.v1',
          'displayName': 'Shared Adapter',
          'protocolKey': 'generic_triple_channel',
          'version': '1.0.0',
          'minAppVersion': '1.0.0',
          'adapterKind': 'codecBacked',
          'codecKey': 'generic_triple_channel_v1',
          'bleNamePrefixes': <String>['TOY'],
          'matching': <String, Object?>{
      ...
      expect(manifest.source, AdapterSource.community);
      expect(manifest.toJson()['source'], 'community');
    });
