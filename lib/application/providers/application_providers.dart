...
enum HardwareRuntimeMode { mockBle, realBle }

final hardwareRuntimeModeProvider = Provider<HardwareRuntimeMode>((_) {
  const bool useRealBle = bool.fromEnvironment(
    'TOYLINK_USE_REAL_BLE',
    defaultValue: false,
  );
  return useRealBle ? HardwareRuntimeMode.realBle : HardwareRuntimeMode.mockBle;
});
...
final consumeRemoteBridgeTaskUseCaseProvider =
    Provider<ConsumeRemoteBridgeTaskUseCase>((ref) {
      return ConsumeRemoteBridgeTaskUseCase(
        remoteBridgeService: ref.watch(remoteBridgeServiceProvider),
