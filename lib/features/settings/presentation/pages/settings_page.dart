...
import '../../../../shared/widgets/hardware_runtime_mode_info.dart';
...
class SettingsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final HardwareRuntimeMode hardwareRuntimeMode = ref.watch(
          ...
          children: <Widget>[
            ...
            Card(
              child: ListTile(
                ...
                subtitle: Text(bridgeSourceDescription(bridgeSource)),
                trailing: Text(bridgeSourceLabel(bridgeSource)),
              ),
            ),
            const SizedBox(height: 12),
            Card(
              child: ListTile(
                title: const Text('当前硬件模式'),
                subtitle: Text(
                  hardwareRuntimeModeDescription(hardwareRuntimeMode),
                ),
                trailing: Text(hardwareRuntimeModeLabel(hardwareRuntimeMode)),
              ),
            ),
            if (bridgeSource == RemoteBridgeRuntimeSource.savedConfig &&
              ...
              Align(
                ...
                bridgeSource == RemoteBridgeRuntimeSource.disabled ||
